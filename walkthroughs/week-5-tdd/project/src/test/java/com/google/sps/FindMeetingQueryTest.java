...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void optionalAttendeeDisregarded() {
    // Have three people have different events where one is an optional attendee busy all day. 
    // We should see three options because the mandatory people are available to meet outside
    // their restricted times.
  ...
  public void optionalAttendeeRegarded() {
    ...
    // We should see two options because the mandatory people and optional person are 
    // available to meet outside their restricted times.
  ...
  @Test
  public void optionalOnlyEvent() {
    // Have two optional attendees have room in their schedules. We should see three options because 
  ...
  @Test
  public void optionalOnlyEventImpossible() {
    // Have two optional attendees, but make it so there is no room at any point in the day to
    // have the meeting.
    //
    // Events  : |----A----||-----B-----|
    // Day     : |----------------------|
  ...
  @Test
  public void noFreeRoom() {
    // Have one person, but make it so that there is no room at any point in the day to
    // have the meeting.
    //
    // Events  : |----A----||-----A----|
    // Day     : |---------------------|
